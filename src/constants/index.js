...
// For 3 cards in synthetic Data Generation end here.
...
export const dashboard1 = [
  {
    ...
    text: "Pick your own model type or chose from the menu.",
    backgroundUrl: "./src/assets/benefits/card-1.svg",
    iconUrl: benefitIcon1,
    imageUrl: benefitImage2,
  },
  {
    id: "1",
    title: "Generate tabular data",
    text: "Generate high queality synthetic tabular synthetic data generation",
    backgroundUrl: "./src/assets/benefits/card-2.svg",
    iconUrl: benefitIcon2,
    imageUrl: benefitImage2,
    light: true,
  ...
  {
    id: "2",
    title: "Synthesis your data",
    text: "Synthesis high queality synthetic tabular synthetic data generation",
    backgroundUrl: "./src/assets/benefits/card-3.svg",
    iconUrl: benefitIcon3,
    imageUrl: benefitImage2,
  },
