            ...
            {openDiv === 'div1' && (
              <>
                ...
                <div className='flex flex-col justify-center border bg-[#000000] mx-[30px] mb-[20px] mt-[10px] border-gray-500 items-center'>
                  <button className="bg-purple-500 py-[7px] px-[10px] text-white text-[15px] mb-[10px] mt-[30px] border-white rounded-md">Choose File</button>
          ...
          <div className='border border-gray-500 mt-[20px] pt-[17px] pl-[17px]'>
            ...
            {openDiv === 'div2' && (
              <>
                ...
                <form className="ml-[30px] mb-[30px] max-w-sm bg">
                  <label htmlFor="countries" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"></label>
                  <select id="data_artifact" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-purple-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
